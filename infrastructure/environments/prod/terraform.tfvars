...
environment  = "prod"         # Environment name: dev, staging, or prod
...
domain_name = "ecs-standalone.your-account-alias-prod.np.org-aws.net"  # Your application's domain name (where users access your app)
zone_name   = "your-account-alias-prod.np.org-aws.net"              # Your Route53 hosted zone (parent domain)
...
db_name     = "ecsstandaloneprod"  # Database name (alphanumeric only, no hyphens)
...
# container_image = "123456789.dkr.ecr.eu-west-1.amazonaws.com/ecs-standalone-prod:v1.0" 
container_image  = "670943688569.dkr.ecr.eu-west-1.amazonaws.com/ecs-standalone-prod:v1.3"
ecs_desired_count = 2
container_port   = 80
